import { Container, Nav, Navbar as BtNavbar, Form, Button } from "react-bootstrap"
    ...
    return (
            <BtNavbar className="navBar" bg="light" expand="lg">
                <Container className="navBarContainer">
                    <NavLink className="navBarBrand" to="/">Adidas</NavLink>
                    ...
                    <BtNavbar.Collapse id="basic-navbar-nav" className="NavContainer">
                        <Nav className="me-auto NavLinkContainer" >
                            <NavLink className={ ( { isActive } ) => isActive ? "navBotonActive" : "navBotonInactive"} to="/categoria/remeras">Remeras</NavLink>
                            <NavLink className={ ( { isActive } ) => isActive ? "navBotonActive" : "navBotonInactive"} to="/categoria/pantalones">Pantalones</NavLink>
                            <NavLink className={ ( { isActive } ) => isActive ? "navBotonActive" : "navBotonInactive"} to="/categoria/accesorios">Accesorios</NavLink>
