...
const cantidadTotal = () => cartList.reduce ( ( count, objetoProducto ) => count += objetoProducto.cantidad, 0)

    // precio total

const precioTotal = () => cartList.reduce ( ( count, objetoProducto ) => count += (objetoProducto.cantidad * objetoProducto.precio), 0)
